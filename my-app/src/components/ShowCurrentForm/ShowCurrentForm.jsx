...
import RuleContainer from '../Sidebar/RuleContainer'
import {editRule} from '../../redux/action'
...
function ShowCurrentForm({ id }) {
    ...
    const [newActionArr, setNewActionArr] = useState([...actionRules]);
  ...
  ============================================================ */
    const handleActions = () => {
        setNewActionArr([...newActionArr,0])
    }
    ...
    const handleButtonName = (value) => {
        dispatch(editRule({...currentArr,buttonName:value}))
        setButtonName(value);
        ...
        <div>
            <div id='create_form_container'>
                ...
                <div className="buttonName">
                    <h4>Button Name</h4>
                    {
                        toggleButton === false ? <input type="text" id='buttonName' value={buttonName} /> : <input type="text" id='buttonName' value={buttonName} onChange={(event)=>handleButtonName(event.target.value)} />
                ...
                {
                    newActionArr.length < 5 && toggleButton && <CreateButton buttonName={"Add another action"} onClick={handleActions} />
                }
